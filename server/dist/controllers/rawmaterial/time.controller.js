...
exports.getPurchaseOrderTimeline = exports.getPurchaseOrdersByProduct = void 0;
const prisma_1 = require("../../generated/prisma");
const prisma = new prisma_1.PrismaClient();
// 1. Get Purchase Orders for a Product
const getPurchaseOrdersByProduct = async (req, res) => {
...
exports.getPurchaseOrdersByProduct = getPurchaseOrdersByProduct;
// 2. Get Timeline Details for a Purchase Order
const getPurchaseOrderTimeline = async (req, res) => {
    const { id } = req.params;
    if (!id) {
        ...
        for (const item of po.items) {
            ...
            for (const job of processingJobs) {
                ...
                if (job.finishedAt) {
                    ...
                    if (byProductSum._sum.quantity)
                        byProduct = byProductSum._sum.quantity;
                    events.push({
                        type: 'PROCESSED',
                        date: job.finishedAt,
...
exports.getPurchaseOrderTimeline = getPurchaseOrderTimeline;
